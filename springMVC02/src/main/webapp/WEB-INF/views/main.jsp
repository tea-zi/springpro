  ...
  <script>
  	...
  	function makeView(data){
		...
		$.each(data, function(index,obj){
			...
			listHtml += "<textarea row='7' id='ta"+obj.idx+"' class='form-control' readonly='readonly'></textarea>"
			listHtml += "<br>";
  	...
  	function goUpdateForm(idx){
  		...
  		$("#t"+idx).html(newInput);
  		var newButton="<button class='btn btn-primary btn-sm' onclick='goUpdate("+idx+")'>완료</button>";
...
<body>
	<div class="container">
	  ...
	  <div class="panel panel-default">
	    ...
	    <div class="panel-footer">Inflearn_Spring</div>
	  </div>
	</div>
</body>
</html>
